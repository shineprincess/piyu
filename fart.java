...
public class Farts
{
	public static void main ( String[] args)
	{
		...
		HashMap <String ,String>letters=new HashMap<String ,String>();
			...
			letters.put("M", "GENEROUS");
			letters.put("N", "BEAUTIFULLY");
			letters.put("O", "SCRAWNY");
			letters.put("P", "PRINCESS");
		...
		System.out.print("Your are a "+ letters.get(letter) + " "+  days.get(day) +" FART");
